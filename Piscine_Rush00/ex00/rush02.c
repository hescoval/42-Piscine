...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/23 04:29:38 by hescoval          #+#    #+#             */
/*   Updated: 2023/07/23 04:29:40 by hescoval         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((curr_x == 1 && curr_y == 1) || (curr_x == x && curr_y == 1))
	{
		ft_putchar('A');
	}
	else if ((curr_x == 1 && curr_y == y) || (curr_x == x && curr_y == y))
	{
		ft_putchar('C');
	}
